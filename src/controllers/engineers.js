...
module.exports = {
  ...
  createEngineer: (req, res) => {
    ...
    engineersModel.createEngineer(data)
      .then(result => {
        return responseHelper.response(res, 200, false, 'Success create a new engineer', {}, data)
      })
      .catch(err => {
  ...
  updateEngineer: (req, res) => {
    ...
    engineersModel.updateEngineer(data, id)
      .then(result => {
        return responseHelper.response(res, 200, false, `Success update engineer with id: ${id}`, {}, data)
      })
      .catch(err => {
  ...
  deleteEngineer: (req, res) => {
    ...
    engineersModel.deleteEngineer(id)
      .then(result => {
        return responseHelper.response(res, 200, false, `Success delete engineer with id: ${id}`)
      })
      .catch(err => {
