...
module.exports = {
  getCompanies: (req, res) => {
    companiesModel.getCompanies()
      .then(result => {
        return responseHelper.response(res, 200, false, 'Success get companies', {}, result)
      })
      .catch(err => {
  ...
  createCompany: (req, res) => {
    ...
    companiesModel.createCompany(data)
      .then(result => {
        return responseHelper.response(res, 200, false, 'Success create a new company', {}, data)
      })
      .catch(err => {
  ...
  updateCompany: (req, res) => {
    ...
    companiesModel.updateCompany(data, id)
      .then(result => {
        return responseHelper.response(res, 200, false, `Success update company with id: ${id}`, {}, data)
      })
      .catch(err => {
  ...
  deleteCompany: (req, res) => {
    ...
    companiesModel.deleteCompany(id)
      .then(result => {
        return responseHelper.response(res, 200, false, `Success delete company with id: ${id}`)
      })
      .catch(err => {
